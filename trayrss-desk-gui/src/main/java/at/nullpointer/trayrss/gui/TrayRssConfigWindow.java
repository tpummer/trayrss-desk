...
public class TrayRssConfigWindow {
    ...
    private void initialize() {
        ...
        frmTrayrss.setIconImage( Toolkit.getDefaultToolkit().getImage(
                TrayRssConfigWindow.class.getResource( "/images/rss-icon.png" ) ) );
        frmTrayrss.setTitle( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.window.title", "TrayRSS - Configuration" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        tabbedPane.addTab(
                Messages.getMessageResolver( Messages.CONFIG ).getString( "config.general.tab.title", "General" ),
                new ImageIcon( TrayRssConfigWindow.class.getResource( "/images/general.png" ) ), pnlGeneral, null );
        ...
        JLabel lblDisplayCount = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.general.displaycount.label", "Display Count" ) );
        ...
        JLabel lblDisplayTime = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.general.displaytime.label", "Display Time" ) );
        pnlDisplayTime.add( lblDisplayTime );

        txtDisplaytime = new JTextField();
        txtDisplaytime.setToolTipText( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.window.displaytime.tooltip", "units are seconds" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        JLabel lblLanguage = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
        ...
        tabbedPane.addTab(
                Messages.getMessageResolver( Messages.CONFIG ).getString( "config.feeds.tab.title", "Feeds" ),
                new ImageIcon( TrayRssConfigWindow.class.getResource( "/images/feed.png" ) ), pnlFeed, null );
        ...
        JButton btnAddFeed = new JButton( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.feeds.button.addfeed", "Add Feed" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        btnAddFeed.setAction( addFeedAction );
        pnlFeedActions.add( btnAddFeed );

        JButton btnEditFeed = new JButton( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.feeds.button.editfeed", "Edit Feed" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        btnEditFeed.setAction( editFeedAction );
        pnlFeedActions.add( btnEditFeed );

        JButton btnRemoveFeed = new JButton( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.feeds.button.removefeed", "Remove Feed" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        tabbedPane
                .addTab(
                        Messages.getMessageResolver( Messages.CONFIG ).getString( "config.timeframes.tab.title",
                                "TimeFrames" ),
                        new ImageIcon( TrayRssConfigWindow.class.getResource( "/images/timeframe.png" ) ),
                        pnlTimeFrame, null );
        ...
        chckbxActivateTimeframes = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.toggle.label", "activate TimeFrames" ) );
        ...
        pnlTimeFrameOptions.setBorder( new TitledBorder( null, Messages.getMessageResolver( Messages.CONFIG )
                .getString( "config.timeframes.border.label", "Time Options" ), TitledBorder.LEADING, TitledBorder.TOP,
                null, null ) );
        ...
        chckbxMonday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.mo.label", "Monday" ) );
        chckbxMonday.setSelected( model.getIsMondayEnabled() );
        pnlTimeFrameDays.add( chckbxMonday );

        chckbxTuesday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.tu.label", "Tuesday" ) );
        chckbxTuesday.setSelected( model.getIsTuesdayEnabled() );
        pnlTimeFrameDays.add( chckbxTuesday );

        chckbxWednesday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.we.label", "Wednesday" ) );
        chckbxWednesday.setSelected( model.getIsWednesdayEnabled() );
        pnlTimeFrameDays.add( chckbxWednesday );

        chckbxThursday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.th.label", "Thursday" ) );
        chckbxThursday.setSelected( model.getIsThursdayEnabled() );
        pnlTimeFrameDays.add( chckbxThursday );

        chckbxFriday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.fr.label", "Friday" ) );
        chckbxFriday.setSelected( model.getIsFridayEnabled() );
        pnlTimeFrameDays.add( chckbxFriday );

        chckbxSaturday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.sa.label", "Saturday" ) );
        chckbxSaturday.setSelected( model.getIsSaturdayEnabled() );
        pnlTimeFrameDays.add( chckbxSaturday );

        chckbxSunday = new JCheckBox( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.checkbox.su.label", "Sunday" ) );
        ...
        JLabel lblTimeframes = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.timeframes.label", "Timeframes" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        JLabel lblVacation = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.vacation.label", "Vacation" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        JLabel lblStart = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.vacation.start.label", "Start" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        JLabel lblEnd = new JLabel( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.timeframes.vacation.end.label", "End" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        JButton btnSave = new JButton( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.window.button.save", "Save" ) ); //$NON-NLS-1$ //$NON-NLS-2$
        btnSave.setAction( saveAction );
        saveExitPanel.add( btnSave );

        JButton btnCancel = new JButton( Messages.getMessageResolver( Messages.CONFIG ).getString(
                "config.window.button.cancel", "Cancel" ) ); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    private class EditFeedAction
        ...
        public EditFeedAction( TrayRssConfigWindow window ) {
            ...
            super( Messages.getMessageResolver( Messages.CONFIG ).getString( "config.feeds.button.editfeed",
                    "Edit Feed" ) );
            this.window = window;
        }
    ...
    private class RemoveFeedAction
            extends AbstractAction {
        ...
        public RemoveFeedAction( TrayRssConfigWindow window ) {
            ...
            super( Messages.getMessageResolver( Messages.CONFIG ).getString( "config.feeds.button.removefeed",
                    "Remove Feed" ) );
            this.window = window;
        }
