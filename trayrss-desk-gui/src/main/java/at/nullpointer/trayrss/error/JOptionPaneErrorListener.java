...
public class JOptionPaneErrorListener
    ...
    public void addError( JComponent where, String title, String text, int messageType ) {
    ...
    public void addError( JComponent where, String title, String text, int messageType, Icon icon ) {

        if ( icon != null ) {
            JOptionPane.showMessageDialog( where, text, title, messageType, icon );
        } else {
            JOptionPane.showMessageDialog( where, text, title, messageType );
        }
