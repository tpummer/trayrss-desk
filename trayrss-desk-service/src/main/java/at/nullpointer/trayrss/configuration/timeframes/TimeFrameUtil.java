...
public class TimeFrameUtil {
    ...
    /**
     * This method is used to extract SingleTimeFrames from a String by splitting them up at the seperator expression
     * " " or ";"
     * 
     * @param frameString
     * @return
    ...
    /**
     * This method is used to transform a set of {@link}SingleTimeFrame to a String representation that can be stored in
     * a property file
     * 
     * @param timeFrames
     * @return
